...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-20 font-sans antialiased md:max-w-[1200px] md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4 md:gap-4">
          <motion.div
            key={active}
            initial={{
              y: 20,
          ...
          >
            ...
            <motion.p className="mt-4 text-dark dark:text-white">
              {testimonials[active].quoteTwo.split(" ").map((word, index) => {
                ...
                const baseDelay = 0.02 * (quoteOneLength - 1) + 0.2;
