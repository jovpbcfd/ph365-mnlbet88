    ...
    <section>
      <div className="max-w-[1200px] mx-auto  text-white">
        ...
        <p className="mt-2">
          ...
          great place to play. People who want the thrill and energy of a real
          casino but would rather play from home can try live dealer games.
          Professionally run companies stream these games in real time, and they
          have live dealers that engage with users in the same manner they would
        ...
        <p className="mt-2">
          ph365 Casino lets players who are always on the go play their favorite
          casino games on their phones, so they can do so anywhere, at any time.
        ...
        <p className="mt-2">
          The ph365 Casino website is always getting better by adding new things
          like live dealer games and mobile betting. The system stays up to date
          with the latest player styles and trends by getting updates and
          improvements all the time. There are many games to choose from, many
          ways to pay, and excellent customer service at the casino, all in a
          secure and safe environment. This shows that they are dedicated to
          giving their customers the best experience possible.
        </p>

        <p className="mt-2">
          At ph365 Casino, the design, ease of use, and mobile compatibility of
          the website all work together to give every player a complete and
          satisfying experience. The ph365 Casino has become a top choice for
          Filipino players looking for a full, interactive, and exciting online
          betting environment thanks to its cutting-edge technology,
          user-centered design, and wide range of games.
        </p>
      </div>
    </section>
  );
